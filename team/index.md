...
<section id="principal-investigator" class="role-section pi-section">
  <h2 class="role-header pi-header" style="text-align:center; justify-content:center; display:flex; gap:0.5rem; align-items:center;">{% include icon.html icon="fa-solid fa-microscope" %}Principal Investigator</h2>
...
<section id="associate-researchers" class="role-section associate-section">
  <h2 class="role-header associate-header" style="text-align:center; justify-content:center; display:flex; gap:0.5rem; align-items:center;">{% include icon.html icon="fa-solid fa-flask" %}Associate Researchers</h2>
...
<section id="postdoctoral-researchers" class="role-section postdoc-section">
  <h2 class="role-header postdoc-header" style="text-align:center; justify-content:center; display:flex; gap:0.5rem; align-items:center;">{% include icon.html icon="fa-solid fa-graduation-cap" %}Postdoctoral Researchers</h2>
...
<section id="students" class="role-section student-section">
  <h2 class="role-header student-header" style="text-align:center; justify-content:center; display:flex; gap:0.5rem; align-items:center;">{% include icon.html icon="fa-solid fa-user-graduate" %}Students</h2>
...
<section id="research-assistants" class="role-section assistant-section">
  <h2 class="role-header assistant-header" style="text-align:center; justify-content:center; display:flex; gap:0.5rem; align-items:center;">{% include icon.html icon="fa-solid fa-vial" %}Research Assistants</h2>
